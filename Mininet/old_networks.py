...
class NmapNetwork(Topo):
    ...
    def __init__(self):
        ...
        for i in range(3, 3 + int(self.num_hosts)):
            if i == 3:
                # h3 : openvas
                host = self.addDocker("h{}".format(i), ip="10.0.1.{}/24".format(i), dimage="rightscale/openvas")
            elif i == 6:
                # h6 : metasploitable
                host = self.addDocker("h{}".format(i), ip="10.0.1.{}/24".format(i), dimage="tleemcjr/metasploitable2")
            else:
